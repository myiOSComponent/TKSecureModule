...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TKSecureModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/512869343@qq.com/TKSecureModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '512869343@qq.com' => '512869343@qq.com' }
  s.source           = { :git => 'https://github.com/512869343@qq.com/TKSecureModule.git', :tag => s.version.to_s }
